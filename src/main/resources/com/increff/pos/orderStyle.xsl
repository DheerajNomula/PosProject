        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-size="32pt" text-align="center" font-family="Helvetica" color="blue"
                    ...
                    <fo:block font-size="10pt">
                        <fo:table table-layout="fixed" width="100%" border-collapse="separate">
                            ...
                            <fo:table-body>
                                <xsl:apply-templates
                                        select="order"/> <!-- branch tag is taken and pasted in below used template 46 line-->
                            </fo:table-body>
                        </fo:table>
                    </fo:block>
                    <fo:block font-size="16pt" font-family="Helvetica" color="black" font-weight="bold"
                              space-after="5mm">
                        Total Amount : Rs.
